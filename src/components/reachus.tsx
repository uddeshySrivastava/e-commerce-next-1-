  ...
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <form className="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2">
      ...
      <div className="sm:col-span-2">
        <label className="mb-2 inline-block text-sm text-gray-800 sm:text-base">Company</label>
      ...
      <div className="sm:col-span-2">
        <label assName="mb-2 inline-block text-sm text-gray-800 sm:text-base">Email*</label>
